...
The methodology is described in the paper "Language on the move: Migration and linguistic diversity", available as a preprint [here]([preprint/MigLingDiv_preprint.pdf](https://zenodo.org/records/19254845)).
